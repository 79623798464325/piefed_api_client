  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.activeDaily, activeDaily) || other.activeDaily == activeDaily) &&
            (identical(other.activeWeekly, activeWeekly) || other.activeWeekly == activeWeekly) &&
            (identical(other.activeMonthly, activeMonthly) || other.activeMonthly == activeMonthly) &&
            (identical(other.active6monthly, active6monthly) || other.active6monthly == active6monthly));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, postCount, postReplyCount, subscriptionsCount, totalSubscriptionsCount, activeDaily, activeWeekly, activeMonthly, active6monthly);
