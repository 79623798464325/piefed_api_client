...
_$PersonImpl _$$PersonImplFromJson(Map<String, dynamic> json) => _$PersonImpl(
  ...
  aboutHtml: json['about_html'] as String?,
  extraFields: (json['extra_fields'] as List<dynamic>?)?.map((e) => UserExtraField.fromJson(e as Map<String, dynamic>)).toList(),
...
_$UserExtraFieldImpl _$$UserExtraFieldImplFromJson(Map<String, dynamic> json) => _$UserExtraFieldImpl(id: (json['id'] as num).toInt(), label: json['label'] as String, text: json['text'] as String);

Map<String, dynamic> _$$UserExtraFieldImplToJson(_$UserExtraFieldImpl instance) => <String, dynamic>{'id': instance.id, 'label': instance.label, 'text': instance.text};

_$CommunityImpl _$$CommunityImplFromJson(Map<String, dynamic> json) => _$CommunityImpl(
  id: (json['id'] as num).toInt(),
  ...
  restrictedToMods: json['restricted_to_mods'] as bool?,
  banned: json['banned'] as bool?,
  questionAnswer: json['question_answer'] as bool?,
  postingWarning: json['posting_warning'] as String?,
...
Map<String, dynamic> _$$CommunityImplToJson(_$CommunityImpl instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'title': instance.title,
  ...
  'restricted_to_mods': instance.restrictedToMods,
  'banned': instance.banned,
  'question_answer': instance.questionAnswer,
  'posting_warning': instance.postingWarning,
...
_$PostImpl _$$PostImplFromJson(Map<String, dynamic> json) => _$PostImpl(
  ...
  imageDetails: json['image_details'] == null ? null : WidthHeight.fromJson(json['image_details'] as Map<String, dynamic>),
  ...
  emojiReactions: (json['emoji_reactions'] as List<dynamic>?)?.map((e) => Reactions.fromJson(e as Map<String, dynamic>)).toList(),
  crossPosts: (json['cross_posts'] as List<dynamic>?)?.map((e) => MiniCrossPosts.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$$PostImplToJson(_$PostImpl instance) => <String, dynamic>{
  ...
  'body': instance.body,
  'url': instance.url,
  'small_thumbnail_url': instance.smallThumbnailUrl,
  'thumbnail_url': instance.thumbnailUrl,
  'alt_text': instance.altText,
  'image_details': instance.imageDetails,
  'published': instance.published.toIso8601String(),
  'updated': instance.updated?.toIso8601String(),
  'ai_generated': instance.aiGenerated,
...
const _$PostTypeEnumMap = {PostType.link: 'Link', PostType.discussion: 'Discussion', PostType.image: 'Image', PostType.video: 'Video', PostType.poll: 'Poll', PostType.event: 'Event'};

_$PostPollImpl _$$PostPollImplFromJson(Map<String, dynamic> json) => _$PostPollImpl(
  endPoll: json['end_poll'] == null ? null : DateTime.parse(json['end_poll'] as String),
  mode: json['mode'] as String?,
  localOnly: json['local_only'] as bool?,
  latestVote: json['latest_vote'] == null ? null : DateTime.parse(json['latest_vote'] as String),
  choices: (json['choices'] as List<dynamic>?)?.map((e) => PollChoice.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
  myVotes: (json['my_votes'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList(),
);

Map<String, dynamic> _$$PostPollImplToJson(_$PostPollImpl instance) => <String, dynamic>{
  'end_poll': instance.endPoll?.toIso8601String(),
  'mode': instance.mode,
  'local_only': instance.localOnly,
  'latest_vote': instance.latestVote?.toIso8601String(),
  'choices': instance.choices,
  'my_votes': instance.myVotes,
};

_$PollChoiceImpl _$$PollChoiceImplFromJson(Map<String, dynamic> json) =>
    _$PollChoiceImpl(id: (json['id'] as num).toInt(), choiceText: json['choice_text'] as String, sortOrder: (json['sort_order'] as num?)?.toInt(), numVotes: (json['num_votes'] as num?)?.toInt() ?? 0);

Map<String, dynamic> _$$PollChoiceImplToJson(_$PollChoiceImpl instance) => <String, dynamic>{
  'id': instance.id,
  'choice_text': instance.choiceText,
  'sort_order': instance.sortOrder,
  'num_votes': instance.numVotes,
};

_$WidthHeightImpl _$$WidthHeightImplFromJson(Map<String, dynamic> json) => _$WidthHeightImpl(width: (json['width'] as num?)?.toInt(), height: (json['height'] as num?)?.toInt());

Map<String, dynamic> _$$WidthHeightImplToJson(_$WidthHeightImpl instance) => <String, dynamic>{'width': instance.width, 'height': instance.height};
...
_$PostEventImpl _$$PostEventImplFromJson(Map<String, dynamic> json) => _$PostEventImpl(
...
Map<String, dynamic> _$$PostEventImplToJson(_$PostEventImpl instance) => <String, dynamic>{
...
_$ReactionsImpl _$$ReactionsImplFromJson(Map<String, dynamic> json) => _$ReactionsImpl(
  url: json['url'] as String?,
...
Map<String, dynamic> _$$ReactionsImplToJson(_$ReactionsImpl instance) => <String, dynamic>{
  'url': instance.url,
...
_$MiniCrossPostsImpl _$$MiniCrossPostsImplFromJson(Map<String, dynamic> json) =>
    _$MiniCrossPostsImpl(postId: (json['post_id'] as num).toInt(), replyCount: (json['reply_count'] as num).toInt(), communityName: json['community_name'] as String);

Map<String, dynamic> _$$MiniCrossPostsImplToJson(_$MiniCrossPostsImpl instance) => <String, dynamic>{
  'post_id': instance.postId,
  'reply_count': instance.replyCount,
  'community_name': instance.communityName,
};

_$CommunityFlairImpl _$$CommunityFlairImplFromJson(Map<String, dynamic> json) => _$CommunityFlairImpl(
  id: (json['id'] as num).toInt(),
  communityId: (json['community_id'] as num).toInt(),
...
Map<String, dynamic> _$$CommunityFlairImplToJson(_$CommunityFlairImpl instance) => <String, dynamic>{
  'id': instance.id,
  'community_id': instance.communityId,
...
_$SiteImpl _$$SiteImplFromJson(Map<String, dynamic> json) => _$SiteImpl(
  ...
  sidebarMd: json['sidebar_md'] as String?,
  userCount: (json['user_count'] as num?)?.toInt(),
  allLanguages: (json['all_languages'] as List<dynamic>?)?.map((e) => LanguageView.fromJson(e as Map<String, dynamic>)).toList(),
);

Map<String, dynamic> _$$SiteImplToJson(_$SiteImpl instance) => <String, dynamic>{
  'actor_id': instance.actorId,
  'name': instance.name,
  'description': instance.description,
  'icon': instance.icon,
...
Map<String, dynamic> _$$CommentImplToJson(_$CommentImpl instance) => <String, dynamic>{
  'id': instance.id,
  'ap_id': instance.apId,
  'user_id': instance.userId,
  'post_id': instance.postId,
