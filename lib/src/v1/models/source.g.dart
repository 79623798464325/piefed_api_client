...
_$PostPollImpl _$$PostPollImplFromJson(Map<String, dynamic> json) => _$PostPollImpl(
  ...
  options: (json['options'] as List<dynamic>?)?.map((e) => PollChoice.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
...
_$PollChoiceImpl _$$PollChoiceImplFromJson(Map<String, dynamic> json) => _$PollChoiceImpl(id: (json['id'] as num).toInt(), text: json['text'] as String, count: (json['count'] as num?)?.toInt() ?? 0);

Map<String, dynamic> _$$PollChoiceImplToJson(_$PollChoiceImpl instance) => <String, dynamic>{'id': instance.id, 'text': instance.text, 'count': instance.count};
