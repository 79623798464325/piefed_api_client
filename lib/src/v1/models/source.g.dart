...
_$PostImpl _$$PostImplFromJson(Map<String, dynamic> json) => _$PostImpl(
  ...
  imageDetails:
      json['image_details'] == null
          ? null
          : WidthHeight.fromJson(json['image_details'] as Map<String, dynamic>),
...
_$PostPollImpl _$$PostPollImplFromJson(Map<String, dynamic> json) =>
    _$PostPollImpl(
      endPoll:
          json['end_poll'] == null
              ? null
              : DateTime.parse(json['end_poll'] as String),
      mode: json['mode'] as String?,
      localOnly: json['local_only'] as bool?,
      latestVote:
          json['latest_vote'] == null
              ? null
              : DateTime.parse(json['latest_vote'] as String),
      choices:
...
_$PollChoiceImpl _$$PollChoiceImplFromJson(Map<String, dynamic> json) =>
    _$PollChoiceImpl(
      ...
      numVotes: (json['num_votes'] as num?)?.toInt() ?? 0,
    );
...
_$WidthHeightImpl _$$WidthHeightImplFromJson(Map<String, dynamic> json) =>
    _$WidthHeightImpl(
      width: (json['width'] as num?)?.toInt(),
      height: (json['height'] as num?)?.toInt(),
    );

Map<String, dynamic> _$$WidthHeightImplToJson(_$WidthHeightImpl instance) =>
...
_$ConversationReportImpl _$$ConversationReportImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ConversationReportImplToJson(
  _$ConversationReportImpl instance,
) => <String, dynamic>{
  'id': instance.id,
  'creator_id': instance.creatorId,
...
_$UserRegistrationImpl _$$UserRegistrationImplFromJson(
  ...
  throwawayEmail: json['throwaway_email'] as bool?,
  userId: (json['user_id'] as num).toInt(),
  ...
  approvedBy:
      json['approved_by'] == null
          ? null
          : Person.fromJson(json['approved_by'] as Map<String, dynamic>),
  approvedAt:
...
Map<String, dynamic> _$$UserRegistrationImplToJson(
  ...
  'throwaway_email': instance.throwawayEmail,
  'user_id': instance.userId,
...
_$CaptchaFieldsImpl _$$CaptchaFieldsImplFromJson(Map<String, dynamic> json) =>
    _$CaptchaFieldsImpl(
...
Map<String, dynamic> _$$CaptchaFieldsImplToJson(_$CaptchaFieldsImpl instance) =>
    <String, dynamic>{
      'png': instance.png,
      'wav': instance.wav,
      'uuid': instance.uuid,
