...
_$PrivateMessageReportViewImpl _$$PrivateMessageReportViewImplFromJson(
  ...
  privateMessageReport:
      json['private_message_report'] == null
          ? null
          : PrivateMessageReport.fromJson(
  ...
  privateMessageCreator:
      json['private_message_creator'] == null
          ? null
          : Person.fromJson(
...
_$ConversationInfoViewImpl _$$ConversationInfoViewImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ConversationInfoViewImplToJson(
  _$ConversationInfoViewImpl instance,
) => <String, dynamic>{
  'id': instance.id,
...
_$ConversationReportViewImpl _$$ConversationReportViewImplFromJson(
  Map<String, dynamic> json,
) => _$ConversationReportViewImpl(
  conversationReport: ConversationReport.fromJson(
    json['conversation_report'] as Map<String, dynamic>,
  ),
  conversationInformation: ConversationInfoView.fromJson(
    json['conversation_information'] as Map<String, dynamic>,
  ),
  messageHistory:
      (json['message_history'] as List<dynamic>?)
          ?.map((e) => PrivateMessageView.fromJson(e as Map<String, dynamic>))
          .toList(),
  creator: Person.fromJson(json['creator'] as Map<String, dynamic>),
);

Map<String, dynamic> _$$ConversationReportViewImplToJson(
  _$ConversationReportViewImpl instance,
) => <String, dynamic>{
  'conversation_report': instance.conversationReport,
  'conversation_information': instance.conversationInformation,
  'message_history': instance.messageHistory,
  'creator': instance.creator,
};
