...
_$MediaViewImpl _$$MediaViewImplFromJson(Map<String, dynamic> json) => _$MediaViewImpl(url: json['url'] as String, name: json['name'] as String?);

Map<String, dynamic> _$$MediaViewImplToJson(_$MediaViewImpl instance) => <String, dynamic>{'url': instance.url, 'name': instance.name};

_$CommentLikeViewImpl _$$CommentLikeViewImplFromJson(Map<String, dynamic> json) => _$CommentLikeViewImpl(
  creator: Person.fromJson(json['creator'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$CommentLikeViewImplToJson(_$CommentLikeViewImpl instance) => <String, dynamic>{
  'creator': instance.creator,
