...
_$AddModImpl _$$AddModImplFromJson(Map<String, dynamic> json) => _$AddModImpl(
...
Map<String, dynamic> _$$AddModImplToJson(_$AddModImpl instance) =>
    <String, dynamic>{
...
_$GetCommunityBansImpl _$$GetCommunityBansImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$GetCommunityBansImplToJson(
  _$GetCommunityBansImpl instance,
) => <String, dynamic>{
  'community_id': instance.communityId,
  'auth': instance.auth,
};
