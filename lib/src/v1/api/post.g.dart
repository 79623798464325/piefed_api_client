...
Map<String, dynamic> _$$ReportPostImplToJson(_$ReportPostImpl instance) =>
    <String, dynamic>{
...
_$GetPostRepliesImpl _$$GetPostRepliesImplFromJson(Map<String, dynamic> json) =>
    _$GetPostRepliesImpl(
      postId: (json['post_id'] as num).toInt(),
      auth: json['auth'] as String?,
    );

Map<String, dynamic> _$$GetPostRepliesImplToJson(
  _$GetPostRepliesImpl instance,
) => <String, dynamic>{
  'post_id': instance.postId,
  if (instance.auth case final value?) 'auth': value,
};
