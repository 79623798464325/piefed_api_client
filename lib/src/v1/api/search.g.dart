...
_$SuggestCompletionImpl _$$SuggestCompletionImplFromJson(Map<String, dynamic> json) => _$SuggestCompletionImpl(q: json['q'] as String);

Map<String, dynamic> _$$SuggestCompletionImplToJson(_$SuggestCompletionImpl instance) => <String, dynamic>{'q': instance.q};
