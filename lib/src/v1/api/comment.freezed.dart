...
MarkCommentAsDistinguished _$MarkCommentAsDistinguishedFromJson(
  Map<String, dynamic> json,
) {
  return _MarkCommentAsDistinguished.fromJson(json);
}

/// @nodoc
mixin _$MarkCommentAsDistinguished {
  @JsonKey(name: 'comment_reply_id')
  int get commentReplyId => throw _privateConstructorUsedError;
  bool get distinguished => throw _privateConstructorUsedError;
  String get auth => throw _privateConstructorUsedError;

  /// Serializes this MarkCommentAsDistinguished to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of MarkCommentAsDistinguished
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $MarkCommentAsDistinguishedCopyWith<MarkCommentAsDistinguished>
  get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MarkCommentAsDistinguishedCopyWith<$Res> {
  factory $MarkCommentAsDistinguishedCopyWith(
    MarkCommentAsDistinguished value,
    $Res Function(MarkCommentAsDistinguished) then,
  ) =
      _$MarkCommentAsDistinguishedCopyWithImpl<
        $Res,
...
/// @nodoc
class _$MarkCommentAsDistinguishedCopyWithImpl<
  $Res,
  $Val extends MarkCommentAsDistinguished
>
    implements $MarkCommentAsDistinguishedCopyWith<$Res> {
  _$MarkCommentAsDistinguishedCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MarkCommentAsDistinguishedImplCopyWith<$Res>
    implements $MarkCommentAsDistinguishedCopyWith<$Res> {
  factory _$$MarkCommentAsDistinguishedImplCopyWith(
    _$MarkCommentAsDistinguishedImpl value,
    $Res Function(_$MarkCommentAsDistinguishedImpl) then,
  ) = __$$MarkCommentAsDistinguishedImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'comment_reply_id') int commentReplyId,
...
/// @nodoc
class __$$MarkCommentAsDistinguishedImplCopyWithImpl<$Res>
    extends
        _$MarkCommentAsDistinguishedCopyWithImpl<
          $Res,
          _$MarkCommentAsDistinguishedImpl
        >
    implements _$$MarkCommentAsDistinguishedImplCopyWith<$Res> {
  __$$MarkCommentAsDistinguishedImplCopyWithImpl(
    _$MarkCommentAsDistinguishedImpl _value,
    $Res Function(_$MarkCommentAsDistinguishedImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$MarkCommentAsDistinguishedImpl extends _MarkCommentAsDistinguished {
  const _$MarkCommentAsDistinguishedImpl({
    @JsonKey(name: 'comment_reply_id') required this.commentReplyId,
    required this.distinguished,
    required this.auth,
  }) : super._();

  factory _$MarkCommentAsDistinguishedImpl.fromJson(
    Map<String, dynamic> json,
  ) => _$$MarkCommentAsDistinguishedImplFromJson(json);
  ...
  @override
  String toString() {
    return 'MarkCommentAsDistinguished(commentReplyId: $commentReplyId, distinguished: $distinguished, auth: $auth)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MarkCommentAsDistinguishedImpl &&
            (identical(other.commentReplyId, commentReplyId) ||
                other.commentReplyId == commentReplyId) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, commentReplyId, distinguished, auth);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MarkCommentAsDistinguishedImplCopyWith<_$MarkCommentAsDistinguishedImpl>
  get copyWith => __$$MarkCommentAsDistinguishedImplCopyWithImpl<
    _$MarkCommentAsDistinguishedImpl
  >(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MarkCommentAsDistinguishedImplToJson(this);
  }
}

abstract class _MarkCommentAsDistinguished extends MarkCommentAsDistinguished {
  const factory _MarkCommentAsDistinguished({
    @JsonKey(name: 'comment_reply_id') required final int commentReplyId,
    required final bool distinguished,
    required final String auth,
  }) = _$MarkCommentAsDistinguishedImpl;
  const _MarkCommentAsDistinguished._() : super._();

  factory _MarkCommentAsDistinguished.fromJson(Map<String, dynamic> json) =
      _$MarkCommentAsDistinguishedImpl.fromJson;
...
class _$ListCommentReportsImpl extends _ListCommentReports {
  ...
  @override
  String toString() {
    return 'ListCommentReports(commentId: $commentId, communityId: $communityId, limit: $limit, page: $page, unresolvedOnly: $unresolvedOnly, auth: $auth)';
  }
