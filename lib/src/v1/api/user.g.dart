...
_$MarkAllNotificationsAsReadImpl _$$MarkAllNotificationsAsReadImplFromJson(
  Map<String, dynamic> json,
) => _$MarkAllNotificationsAsReadImpl(auth: json['auth'] as String);
...
_$GetUserMediaImpl _$$GetUserMediaImplFromJson(Map<String, dynamic> json) =>
    _$GetUserMediaImpl(
      limit: (json['limit'] as num?)?.toInt(),
      page: (json['page'] as num?)?.toInt(),
      sort: json['sort'] as String?,
...
Map<String, dynamic> _$$GetUserMediaImplToJson(_$GetUserMediaImpl instance) =>
    <String, dynamic>{
      'limit': instance.limit,
      'page': instance.page,
      'sort': instance.sort,
...
_$MarkAllAsReadUserImpl _$$MarkAllAsReadUserImplFromJson(
  Map<String, dynamic> json,
) => _$MarkAllAsReadUserImpl(auth: json['auth'] as String);

Map<String, dynamic> _$$MarkAllAsReadUserImplToJson(
  _$MarkAllAsReadUserImpl instance,
) => <String, dynamic>{'auth': instance.auth};

_$AddUserNoteImpl _$$AddUserNoteImplFromJson(Map<String, dynamic> json) =>
    _$AddUserNoteImpl(
      personId: (json['person_id'] as num).toInt(),
...
Map<String, dynamic> _$$AddUserNoteImplToJson(_$AddUserNoteImpl instance) =>
    <String, dynamic>{
      'person_id': instance.personId,
      'note': instance.note,
      'auth': instance.auth,
...
_$SetUserFlairImpl _$$SetUserFlairImplFromJson(Map<String, dynamic> json) =>
    _$SetUserFlairImpl(
      communityId: (json['community_id'] as num).toInt(),
      flairText: json['flair_text'] as String?,
      auth: json['auth'] as String,
    );

Map<String, dynamic> _$$SetUserFlairImplToJson(_$SetUserFlairImpl instance) =>
    <String, dynamic>{
      'community_id': instance.communityId,
      'flair_text': instance.flairText,
      'auth': instance.auth,
    };

_$VerifyCredentialsImpl _$$VerifyCredentialsImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$VerifyCredentialsImplToJson(
  _$VerifyCredentialsImpl instance,
) => <String, dynamic>{
  'username': instance.username,
  'password': instance.password,
};

_$UpdateNotificationStateImpl _$$UpdateNotificationStateImplFromJson(
  Map<String, dynamic> json,
) => _$UpdateNotificationStateImpl(
  notifId: (json['notif_id'] as num).toInt(),
  readState: json['read_state'] as bool,
  auth: json['auth'] as String,
);

Map<String, dynamic> _$$UpdateNotificationStateImplToJson(
  _$UpdateNotificationStateImpl instance,
) => <String, dynamic>{
...
Map<String, dynamic> _$$SubscribeUserImplToJson(_$SubscribeUserImpl instance) =>
    <String, dynamic>{
      'person_id': instance.personId,
