...
Map<String, dynamic> _$$FollowCommunityImplToJson(_$FollowCommunityImpl instance) => <String, dynamic>{'community_id': instance.communityId, 'follow': instance.follow, 'auth': instance.auth};
