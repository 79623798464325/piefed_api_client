...
_$MarkAllPMsAsReadImpl _$$MarkAllPMsAsReadImplFromJson(
  Map<String, dynamic> json,
) => _$MarkAllPMsAsReadImpl(auth: json['auth'] as String);

Map<String, dynamic> _$$MarkAllPMsAsReadImplToJson(
  _$MarkAllPMsAsReadImpl instance,
