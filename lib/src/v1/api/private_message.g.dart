...
_$ReportPrivateMessageImpl _$$ReportPrivateMessageImplFromJson(Map<String, dynamic> json) =>
    _$ReportPrivateMessageImpl(privateMessageId: (json['private_message_id'] as num).toInt(), reason: json['reason'] as String, auth: json['auth'] as String);

Map<String, dynamic> _$$ReportPrivateMessageImplToJson(_$ReportPrivateMessageImpl instance) => <String, dynamic>{
  'private_message_id': instance.privateMessageId,
  'reason': instance.reason,
  'auth': instance.auth,
};

_$GetPrivateMessageConversationImpl _$$GetPrivateMessageConversationImplFromJson(Map<String, dynamic> json) => _$GetPrivateMessageConversationImpl(
...
Map<String, dynamic> _$$GetPrivateMessageConversationImplToJson(_$GetPrivateMessageConversationImpl instance) => <String, dynamic>{
