...
Map<String, dynamic> _$$ListPrivateMessageReportsImplToJson(
  ...
  if (instance.privateMessageId case final value?) 'private_message_id': value,
  if (instance.limit case final value?) 'limit': value,
  if (instance.page case final value?) 'page': value,
...
_$ReportConversationImpl _$$ReportConversationImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ReportConversationImplToJson(
  _$ReportConversationImpl instance,
) => <String, dynamic>{
...
_$ListConversationReportsImpl _$$ListConversationReportsImplFromJson(
  Map<String, dynamic> json,
  ...
  page: (json['page'] as num?)?.toInt(),
  unresolvedOnly: json['unresolved_only'] as bool?,
  messageHistoryLimit: (json['message_history_limit'] as num?)?.toInt(),
  auth: json['auth'] as String,
);

Map<String, dynamic> _$$ListConversationReportsImplToJson(
  _$ListConversationReportsImpl instance,
) => <String, dynamic>{
  if (instance.conversationId case final value?) 'conversation_id': value,
  if (instance.limit case final value?) 'limit': value,
  if (instance.page case final value?) 'page': value,
  if (instance.unresolvedOnly case final value?) 'unresolved_only': value,
  if (instance.messageHistoryLimit case final value?)
    'message_history_limit': value,
  'auth': instance.auth,
};

_$ResolveConversationReportImpl _$$ResolveConversationReportImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ResolveConversationReportImplToJson(
  _$ResolveConversationReportImpl instance,
) => <String, dynamic>{
  'report_id': instance.reportId,
  'resolved': instance.resolved,
  'auth': instance.auth,
